...
class ProductLang extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('product, language, title, tecdoc_article_name', 'required'),
            array('product, language', 'numerical', 'integerOnly' => true),
            array('title, tecdoc_article_name', 'length', 'max' => 255),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, product, language, title, tecdoc_article_name', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            ...
            '_language_' => array(self::BELONGS_TO, 'Language', 'language'),
        );
    }
